...
<form @submit.prevent="submitForm" class="add-product-form">
    ...
    <input class="input-field" v-model="name" id="name" placeholder="Product Name" />
    ...
    <input class="input-field" v-model="description" id="description" placeholder="Product Description" />
    ...
    <input class="input-field" v-model="price" id="price" placeholder="Product Price" />
